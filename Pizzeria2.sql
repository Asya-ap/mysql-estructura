...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Bebidas` (
  ...
  `Bebida_nombre` VARCHAR(45) NOT NULL,
  `Descripccion` VARCHAR(90) NOT NULL,
  `Imagen` VARBINARY(8000) NULL DEFAULT NULL,
  `Pedido_Pedido_id` INT(11) NOT NULL,
  PRIMARY KEY (`Bebidas_id`),
  INDEX `fk_Bebidas_Pedido1_idx` (`Pedido_Pedido_id` ASC),
  CONSTRAINT `fk_Bebidas_Pedido1`
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Categoria_pizza` (
  ...
  INDEX `fk_Categoria_pizza_Categoria_pizza1_idx` (`Categoria_pizza_Categoria_id` ASC),
  CONSTRAINT `fk_Categoria_pizza_Categoria_pizza1`
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Cliente` (
  ...
  UNIQUE INDEX `Localidad_UNIQUE` (`Localidad` ASC),
  UNIQUE INDEX `Provincia_UNIQUE` (`Provincia` ASC),
  INDEX `fk_Cliente_Localidad_idx` (`Localidad_Localidad_id` ASC),
  INDEX `fk_Cliente_Provincia1_idx` (`Provincia_Provincia_id` ASC),
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Cocinero` (
  `Cocinero_id` INT(11) NOT NULL AUTO_INCREMENT,
  `Cocinero` BIT(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Empleado` (
  ...
  `Restaurante_Restaurante_id` INT(11) NOT NULL,
  `Cocinero_Cocinero_id` INT(11) NOT NULL,
  `Repartidor_Repartidor_id` INT(11) NOT NULL,
  PRIMARY KEY (`Empleado_id`, `Restaurante_Restaurante_id`, `Cocinero_Cocinero_id`, `Repartidor_Repartidor_id`),
  UNIQUE INDEX `Nif_UNIQUE` (`Nif` ASC) ,
  UNIQUE INDEX `Apellidos_UNIQUE` (`Apellidos` ASC),
  INDEX `fk_Empleado_Restaurante1_idx` (`Restaurante_Restaurante_id` ASC) ,
  INDEX `fk_Empleado_Cocinero1_idx` (`Cocinero_Cocinero_id` ASC) ,
  INDEX `fk_Empleado_Repartidor1_idx` (`Repartidor_Repartidor_id` ASC),
  CONSTRAINT `fk_Empleado_Cocinero1`
    FOREIGN KEY (`Cocinero_Cocinero_id`)
    REFERENCES `Pizzeria`.`Cocinero` (`Cocinero_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Empleado_Repartidor1`
    FOREIGN KEY (`Repartidor_Repartidor_id`)
    REFERENCES `Pizzeria`.`Repartidor` (`Repartidor_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Hamburguesas` (
  ...
  `Hamburguesa_nombre` VARCHAR(45) NOT NULL,
  `Descripcion` VARCHAR(90) NOT NULL,
  `Imagen` VARBINARY(8000) NOT NULL,
  `Precio` INT(11) NOT NULL,
  `Pedido_Pedido_id` INT(11) NOT NULL,
  PRIMARY KEY (`Hamburguesas_id`),
  UNIQUE INDEX `Hamburguesa_nombre_UNIQUE` (`Hamburguesa_nombre` ASC) ,
  INDEX `fk_Hamburguesas_Pedido1_idx` (`Pedido_Pedido_id` ASC),
  CONSTRAINT `fk_Hamburguesas_Pedido1`
    FOREIGN KEY (`Pedido_Pedido_id`)
    REFERENCES `Pizzeria`.`Pedido` (`Pedido_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Pizza` (
  ...
  `Pizza_nombre` VARCHAR(45) NOT NULL,
  `Descripccion` VARCHAR(90) NOT NULL,
  `Imagen` VARBINARY(8000) NOT NULL,
  `Precio` INT(11) NOT NULL,
  `Pedido_Pedido_id` INT(11) NOT NULL,
  ...
  PRIMARY KEY (`Pizza_id`, `Categorai_pizza_Categoria_id`, `Categoria_pizza_Categoria_id`, `Categoria_pizza_Categoria_pizza_Categoria_id`),
  UNIQUE INDEX `Pizza_nombre_UNIQUE` (`Pizza_nombre` ASC) ,
  INDEX `fk_Pizza_Pedido1_idx` (`Pedido_Pedido_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`Pizzeria_web` (
  ...
  `N_productos` INT(11) NOT NULL COMMENT 'numero de productos seleccionados',
  ...
  PRIMARY KEY (`Pedido_id`, `Cliente_Cliente_id`, `Cliente_Localidad_Localidad_id`, `Cliente_Provincia_Provincia_id`, `Pedido_Pedido_id`, `Pedido_Pedido_id1`, `Pedido_Restaurante_Restaurante_id`, `Pedido_Repartidor_Repartidor_id`, `Cliente_Cliente_id1`, `Cliente_Localidad_Localidad_id1`, `Cliente_Provincia_Provincia_id1`),
