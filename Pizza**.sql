...
CREATE TABLE IF NOT EXISTS `Optica`.`Proveedor` (
  ...
  `Nume` INT(11) NULL DEFAULT NULL,
  `Codigo_postal` INT(11) NOT NULL,
  `N_piso` INT(11) NULL DEFAULT NULL,
  `N_puerta` INT(11) NULL DEFAULT NULL,
  `Pais` VARCHAR(30) NOT NULL,
  `Ciudad` VARCHAR(45) NOT NULL,
  `Marca_Marca_id` INT NOT NULL,
  PRIMARY KEY (`Proveedor_id`),
  INDEX `fk_Proveedor_Marca1_idx` (`Marca_Marca_id` ASC) ,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Optica`.`Montura` ;

CREATE TABLE IF NOT EXISTS `Optica`.`Montura` (
  `Montura_id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `Optica`.`Gafas` (
  ...
  INDEX `Montura_id` (`Montura_id` ASC) ,
  INDEX `fk_Gafas_Marca1_idx` (`Marca_Marca_id` ASC) ,
  CONSTRAINT `gafas_ibfk_1`
    FOREIGN KEY (`Proveedor_id`)
    REFERENCES `Optica`.`Proveedor` (`Proveedor_id`),
  CONSTRAINT `gafas_ibfk_2`
    FOREIGN KEY (`Montura_id`)
    REFERENCES `Optica`.`Montura` (`Montura_id`),
...
CREATE TABLE IF NOT EXISTS `Optica`.`Ventas` (
  ...
  INDEX `Gafas_id` (`Gafas_id` ASC) ,
  INDEX `Clientes_id` (`Clientes_id` ASC) ,
  INDEX `Empleado_id` (`Empleado_id` ASC) ,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Pizzeria`.`Restaurante` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Pizzeria`.`Entrega_domicilio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Pizzeria`.`Pizzeria_web` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Pizzeria`.`Tipo_productos` ;
